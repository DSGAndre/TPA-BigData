...
#Avant l'exécution du script Analyse.R, nous devons mettre à jour le chemin du 
#répertoire de travail où sont contenus les data :
#1) Cloner le repository Git https://github.com/DSGAndre/TPA-BigData 
#2) Mettre à jour le chemin du répertoire de travail en se rendant sur l'onglet
#Session > Set Working Directory > Choose Director, 
#et en choisissant le répertoire data qui se trouve dans le dossier cloné à l'étape 1 : Analyse_de_donnees/script/data
